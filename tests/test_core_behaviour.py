...
class HealthEndpointTests(unittest.TestCase):
    ...
    def test_diagnostics_battery_configuration_includes_cycles(self):
        ...
        self.assertIn(b'class="cell-table-col-status"', response.data)
        self.assertIn(b'class="cell-table-col-ocv"', response.data)
        self.assertIn(b'class="cell-table-col-balance"', response.data)
